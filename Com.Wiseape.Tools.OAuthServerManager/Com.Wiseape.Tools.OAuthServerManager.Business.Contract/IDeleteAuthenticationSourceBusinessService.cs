...
{
    public interface IDeleteAuthenticationSourceBusinessService
    {
		...
		OperationResult DeleteByAuthenticationSourceName(string authenticationSourceName);
		...
		/// <returns>List of  Authentication Source</returns>
		OperationResult DeleteByAuthenticationLibrary(string authenticationLibrary);
		...
		/// <returns>List of  Authentication Source</returns>
		OperationResult DeleteByAuthenticationClassname(string authenticationClassname);
